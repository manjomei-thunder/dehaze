...
if __name__=='__main__':
    id = torch.randn(1,3,6000,4000)
    id2 = torch.randn(1,3,6000,4000)
    i,j,h,w = transforms.RandomCrop.get_params(id, output_size = (256,256))
    hazy_ = TF.crop(id, i, j, h, w)
    clean_ = TF.crop(id2, i, j, h, w)